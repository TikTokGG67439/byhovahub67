...
local floatSpeed = 5000 -- отдельная скорость для float (настраиваемая)
...
btnFloatDec.MouseButton1Click:Connect(function() floatSpeed = math.clamp(floatSpeed - 100, 1, 300000) updateFloatLabel() end)
btnFloatInc.MouseButton1Click:Connect(function() floatSpeed = math.clamp(floatSpeed + 100, 1, 4000000) updateFloatLabel() end)
updateFloatLabel()
